...
`mempool-lab` is centered on crypto and simulation work in Rust. The technical target is: Simulate mempool admission, replacement rules, fee bands, and block selection.
...
The score is deterministic. The current threshold is 152. Risk has a penalty of 5, latency has a penalty of 3, and weight contributes a bonus of 6.

"""Regression checks for the mempool-lab casebook."""
...
from casebook.harness import assert_expected, mempool_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(mempool_lab_summary(), assert_expected())

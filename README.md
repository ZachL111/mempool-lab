...
mempool-lab is a Rust project for crypto and simulation. It focuses on this technical goal: Simulate mempool admission, replacement rules, fee bands, and block selection.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 152, risk penalty 5, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
